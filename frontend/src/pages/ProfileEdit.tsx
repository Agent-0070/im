            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-glass-light/10 border-gray-300 min-h-[80px]"
                />
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-glass-light/10 border-gray-300 min-h-[100px]"
                />
                <p className="text-xs text-muted-foreground">
                ...
                {formData.hostingCountries.map((country: string | undefined, index: number) => (
                  <div key={index} className="flex gap-2">
                    <Select value={country} onValueChange={(value) => updateHostingCountry(index, value)}>
                      <SelectTrigger className="bg-glass-light/10 border-gray-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-glass-light/10 border-gray-300"
                        />
                      </div>
                      <div>
                  ...
                  <div key={index} className="p-4 border border-gray-300 rounded-lg space-y-3">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        className="bg-glass-light/10 border-gray-300 min-h-[60px]"
                      />
                    </div>
                  </div>
                ))}
