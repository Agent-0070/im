...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen md:pt-16 pt-2 home-page font-poppins">
      ...
      <section className="relative overflow-hidden py-5 lg:py-32 font-poppins">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <span className="bg-[#39dafe] bg-clip-text text-transparent">
                Discover
              </span>{' '}
              Amazing Events
            </motion.h1>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-4 font-salsa text-gray-600">
              Why Choose <span className="bg-gradient-primary bg-clip-text text-[#39dafe] font-salsa">iM</span>?
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:max-w-5xl mx-auto">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
              >
                <Card className="h-full backdrop-blur-glass font-poppins bg-gradient-glass border-glass-border/30 shadow-glass hover:shadow-accent-glow/20 transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-[#B5BBC5] flex items-center justify-center shadow-accent-glow/50">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-primary/5 via-transparent to-accent/5 font-poppins">
        <div className="container mx-auto px-4">
          <motion.div
          ...
          >
            <h2 className="text-[14px] md:text-[27px] text-gray-600 font-[650] mb-4">
              Ready to Get Started?
            </h2>
            <p className="text-[16px] text-[#B5BBC5] mb-8 max-w-2xl mx-auto">
