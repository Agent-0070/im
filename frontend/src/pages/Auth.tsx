              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="login">
                  <form onSubmit={handleLogin} className="space-y-4 font-poppins text-[15px]">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 bg-glass-light/10 border border-gray-300"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 font-poppins">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 pr-10 bg-glass-light/10 border border-gray-300"
                          required
                        />
                        <button
                          type="button"
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-gradient-accent border-0 shadow-accent-glow mt-8"
                      disabled={isLoading}
                    >
