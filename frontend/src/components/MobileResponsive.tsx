...
export const MobileWrapper: React.FC<MobileResponsiveProps> = ({ children }) => {
...
export const SwipeableCard: React.FC<{ children: React.ReactNode; onSwipeLeft?: () => void; onSwipeRight?: () => void }> = ({ 
  children, 
  onSwipeLeft, 
  onSwipeRight 
}) => {
...
export const DeviceOptimizedLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
