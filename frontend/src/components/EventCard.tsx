...
const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    ...
    >
      <Card className={`backdrop-blur-glass font-poppins text-[15px] rounded-xl bg-gradient-glass border border-gray-300 shadow-md hover:shadow-accent-glow/20 transition-all duration-300 overflow-hidden ${isCancelled ? 'opacity-75 grayscale' : ''}`}>
