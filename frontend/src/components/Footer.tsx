...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-glass backdrop-blur-glass border-t border-gray-300 mt-auto font-poppins">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="relative">
                <div className="w-8 h-8  flex items-center justify-center font-[550] text-[#3cdaff] text-[18px] z-10">
                  iM
                </div>
